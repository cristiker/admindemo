		...
		<section>
			<form id="user-search" class="form-horizontal">
				<div class="form-group">
					<label class="col-md-1 control-label">景点名称</label>
					<div class="col-md-2">
						<input type="text" name="subjectName" class="form-control" id="username1"/>
					</div>
					<label class="col-md-1 control-label">景点状态</label>
					<div class="col-md-2">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-body">
							<button type="button" class="btn btn-default btn-sm" onclick="addSight()">新增景点</button>
...
<script src="${base}/static/views/sight/sightlist.js"></script>
</body>
</html>
