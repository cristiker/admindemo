					...
					<div class="box box-primary ">
						...
						<div class="box-footer">
							<div class="form-group col-md-offset-5">
								<div class="col-md-1">
									<button type="submit" class="btn btn-info" onclick="review(${guide.id})">通过</button>
								</div>
								<div class="col-md-1">
									<button type="submit" class="btn btn-info" onclick="reject(${guide.id})">拒绝</button>
								</div>
							</div>
						</div>
					</div>
